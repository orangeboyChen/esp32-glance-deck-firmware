...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    def add_new_entities() -> None:
        ...
        if new_ids:
            async_add_entities(GlanceDeckButton(coordinator, device_id, key, action) for device_id in new_ids for key, action in (("next_page", "next_page"), ("refresh_display", "refresh_release")))
...
class GlanceDeckButton(GlanceDeckEntity, ButtonEntity):
    def __init__(self, coordinator: GlanceDeckCoordinator, device_id: str, key: str, action: str) -> None:
